...
class CollectorDetailEmailTest1 {
    ...
    fun collectorDetailEmailTest1() {
        ...
        val textView = onView(
            allOf(
                withId(R.id.textElementDetail), withText("manollo@caracol.com.co"),
                withParent(
                    allOf(
        ...
        SystemClock.sleep(1500);
        textView.check(matches(withText("manollo@caracol.com.co")))
    }
