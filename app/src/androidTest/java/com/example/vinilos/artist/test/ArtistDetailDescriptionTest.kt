...
class ArtistDetailDescriptionTest {
    ...
    @Test
    fun artistDetailDescriptionTest() {
        ...
        val textView = onView(
            allOf(
                withId(R.id.textLabelDescription), withText("Descripción:"),
                withParent(
                    allOf(
        ...
        SystemClock.sleep(1500);
        textView.check(matches(withText("Descripción:")))
    }
