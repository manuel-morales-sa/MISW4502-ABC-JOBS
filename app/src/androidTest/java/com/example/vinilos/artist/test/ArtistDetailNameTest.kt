...
class ArtistDetailNameTest {
    ...
    fun artistDetailNameTest() {
        ...
        val textView = onView(
            allOf(
                withId(R.id.textContentArtist), withText("Iron Maiden (Banda) "),
                withParent(
                    allOf(
        ...
        SystemClock.sleep(1500);
        textView.check(matches(withText("Iron Maiden (Banda) ")))
    }
